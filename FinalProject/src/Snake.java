...
public class Snake {
    ...
    private final int SNAKE_LENGTH_DEFAULT = 2;
    ...
    public void setJMenueBar(JFrame frame) {
    	...
    	//website above used for help with jmenu
        ...
        instruction.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "We can't help you, it's friggin snake");
            }
        });
    ...
    /**
     * This method is responsible to initialize the snake with two body parts.
     */
    public void createInitSnake() {
        ...
        for (int i = 0; i < totalBodyPart; i++) {
            ...
            snakeBodyPart[i].setBackground(Color.RED);
    ...
    /**
     * This method is here to create the blocks of food the snake grabs
     * We made it so the end of the snake is treated as food instead of being the snake, makes it easier to add another one on
    */
    void createFood() {
     ...
     * http://stackoverflow.com/questions/15192610/java-object-movement
     * website helped with movement
     */
  public void processNextStep() {
        ...
        if(isGameOver(isBorderTouched, newHeadLocX, newHeadLocY)) {
           ...
           return;
            ...
            // Move the whole snake body forward
    ...
    /**
     * This method is here to detect if game is over or not
     * The game will end when snake runs into self or border, if border is on
     */
     ...
     * We must avoid the food that means the last body part of the snake.
     * We write (totalBodyPart - 2) instead of (totalBodyPart - 1).
    ...
    //copyright http://stackoverflow.com/questions/15192610/java-object-movement
    //used website above to help with movement
    // copyright https://docs.oracle.com/javase/tutorial/uiswing/misc/keybinding.html
    // we got how to use keyboard presses in our code from the website above
